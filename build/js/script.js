...
/* harmony import */ var _modules_ranges__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ranges */ "./src/js/modules/ranges.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("load scroll", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() > 1 ? jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header").addClass("is-fixed") : jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header").removeClass("is-fixed");
  });
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_ranges__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
/*!**************************************!*\
  !*** ./src/js/modules/calculator.js ***!
  \**************************************/
/*! exports provided: initialFeeCalculate, sumCalculate, monthlyPaymentCalculate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialFeeCalculate", function() { return initialFeeCalculate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sumCalculate", function() { return sumCalculate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "monthlyPaymentCalculate", function() { return monthlyPaymentCalculate; });
...
var initialFeeCalculate = function initialFeeCalculate(initialPercent, cost) {
  return parseFloat(initialPercent) * parseFloat(cost);
};

var sumCalculate = function sumCalculate(initialFee, term, monthlyPayment) {
  return parseFloat(initialFee) + parseFloat(term) * parseFloat(monthlyPayment);
};

var monthlyPaymentCalculate = function monthlyPaymentCalculate(cost, initialFee, interestRate, term) {
...
var forms = function forms() {
  ...
  inputmask__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    "oncomplete": function oncomplete() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('valid');
    }
  }).mask(phoneInputs);
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.not-validated');
  form.on('submit', function (e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('validated');
  });
  var isCalc = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-is-calc').on('click', function () {
    isCalc = true;
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('form').on('submit', function (e) {
    ...
    if (isCalc) {
      var calcCost = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc-cost').val() + ' ₽';
      var calcInitialFee = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc-initial').val();
      var calcTerm = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc-term').val() + ' мес.';
      var calcSum = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc-sum').text();
      var calcMonthly = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc-monthly').text();
    ...
    if (this.checkValidity()) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        success: function success() {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').removeClass('stop');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".modal-overlay").fadeOut();
        },
...
var modals = function modals() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-btn').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').addClass('stop');
    var href = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(href).fadeIn(300);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-close').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html').removeClass('stop');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-overlay').fadeOut(300);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-overlay').mouseup(function (e) {
    var container = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu-burger').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-menu').addClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-menu__close').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header-menu').removeClass('active');
  });
};
...
/* harmony import */ var nouislider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! nouislider */ "./node_modules/nouislider/distribute/nouislider.js");
...
/* harmony import */ var _calculator__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./calculator */ "./src/js/modules/calculator.js");
...
var ranges = function ranges() {
  var costSlider = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-cost-range')[0],
      costInput = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-cost')[0],
      initialSlider = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-initial-range')[0],
      initialInput = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-initial')[0],
      termSlider = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-term-range')[0],
      termInput = jquery__WEBPACK_IMPORTED_MODULE_7___default()('#calc-term')[0],
      initialValue = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.js-calc-initial'),
      sumValue = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.js-calc-sum'),
      monthlyValue = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.js-calc-monthly');

  function numberWithSpaces(x) {
    return x.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ");
  }

  nouislider__WEBPACK_IMPORTED_MODULE_8___default.a.create(costSlider, {
    start: [3300000],
    connect: [true, false],
    step: 10000,
    range: {
  ...
  costSlider.noUiSlider.on('update', function (values, handle) {
    ...
    var initialPercent = initialInput.value.replace(/\D/g, '') / 100,
        cost = values[handle];
    initialValue.text("".concat(numberWithSpaces(parseFloat(Object(_calculator__WEBPACK_IMPORTED_MODULE_9__["initialFeeCalculate"])(initialPercent, cost)).toFixed(0)), " \u20BD"));
    var initialFee = initialValue.text().replace(/\D/g, ''),
        term = termInput.value;
    monthlyValue.text("".concat(numberWithSpaces(parseFloat(Object(_calculator__WEBPACK_IMPORTED_MODULE_9__["monthlyPaymentCalculate"])(cost, initialFee, 0.01, term)).toFixed(0)), " \u20BD"));
    var monthlyPayment = monthlyValue.text().replace(/\D/g, '');
    sumValue.text("".concat(numberWithSpaces(parseFloat(Object(_calculator__WEBPACK_IMPORTED_MODULE_9__["sumCalculate"])(initialFee, term, monthlyPayment)).toFixed(0)), " \u20BD"));
  });
  ...
  nouislider__WEBPACK_IMPORTED_MODULE_8___default.a.create(initialSlider, {
    start: [13],
    connect: [true, false],
    range: {
      'min': 10,
  ...
  initialSlider.noUiSlider.on('update', function (values, handle) {
    initialInput.value = "".concat(values[handle], "%");
    var initialPercent = values[handle].replace(/\D/g, '') / 100,
  ...
  initialInput.addEventListener('input', function () {
    initialInput.value = "".concat(initialInput.value.replace(/\D/g, ''), "%");
  });
  nouislider__WEBPACK_IMPORTED_MODULE_8___default.a.create(termSlider, {
    start: [60],
    connect: [true, false],
    range: {
      'min': 1,
  ...
  termSlider.noUiSlider.on('update', function (values, handle) {
    ...
    var cost = costInput.value.replace(/\D/g, '');
    var initialFee = initialValue.text().replace(/\D/g, ''),
        term = termInput.value;
    monthlyValue.text("".concat(numberWithSpaces(parseFloat(Object(_calculator__WEBPACK_IMPORTED_MODULE_9__["monthlyPaymentCalculate"])(cost, initialFee, 0.01, term)).toFixed(0)), " \u20BD"));
    var monthlyPayment = monthlyValue.text().replace(/\D/g, '');
...
/* harmony default export */ __webpack_exports__["default"] = (ranges);
...
var slider = function slider() {
  var mainSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-slider');
  ...
  var mainSliderNextBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-slider .slick-next');
  mainSliderNextBtn.append(svgLoader);
  var mainSliderNextBtnLoader = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-slider .slick-next .main-slider__loader');
...
/***/ 0:
/*!***********************************************************************************************************************************************************************!*\
  !*** multi ./src/js/app.js ./src/js/modules/calculator.js ./src/js/modules/forms.js ./src/js/modules/modals.js ./src/js/modules/ranges.js ./src/js/modules/slider.js ***!
  \***********************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\paradigma\code\leasing\src\js\app.js */"./src/js/app.js");
__webpack_require__(/*! D:\paradigma\code\leasing\src\js\modules\calculator.js */"./src/js/modules/calculator.js");
__webpack_require__(/*! D:\paradigma\code\leasing\src\js\modules\forms.js */"./src/js/modules/forms.js");
__webpack_require__(/*! D:\paradigma\code\leasing\src\js\modules\modals.js */"./src/js/modules/modals.js");
__webpack_require__(/*! D:\paradigma\code\leasing\src\js\modules\ranges.js */"./src/js/modules/ranges.js");
module.exports = __webpack_require__(/*! D:\paradigma\code\leasing\src\js\modules\slider.js */"./src/js/modules/slider.js");
